...
En effet dans la \hyperref[tab:article_res_phy]{Table 8}, on peut voir que les performances des KNN, Random Forest, SVM et Naive Bayes (NB) sont TO COMPLETE.
