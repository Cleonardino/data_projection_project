...
\begin{figure}[H]
	\centering
	\begin{tikzpicture}
		\pie[text=legend, rotate=90, before number=, after number=, color={green!30, red!30}]
			{68.6/Normal, 31.4/Anomalie}
	\end{tikzpicture}
	\caption{Répartition globale des données entre normales et anormales}
	\label{fig:global_data_repartition}
\end{figure}
