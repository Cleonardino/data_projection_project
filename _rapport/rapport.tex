...
=======
>>>>>>> 723f7ce7c2996f6ab85fbd0fd74143c1a4ee7dec
\newpage
...
Par contre, j'ai relevé un gros problème dans le papier associé au dataset, il n'y pas de code fourni accompagnant le papier avec toutes les indications pour pouvoir exactement reproduire les données du papier. On a donc par exemple un doute sur s'ils ont fait un F1 score maco ou un F1 score weighted. Personnelement, je ne comprends pas du tout comment un papier sans code publique peut être accepté dans une grande conférence (comme IEEE) sans fournir un code qui permet aux autres chercheurs de comparer et de comprendre pourquoi ils n'ont pas les mêmes résultats que ceux du papier, et on ne peut donc aussi absolument pas vérifier qu'ils n'aient pas triché d'une manière ou d'une autre.
