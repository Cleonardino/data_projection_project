...
\begin{table}[H]
    ...
    \begin{tabular}{c l c c c c c}
    	...
    	\textbf{Rang} & \textbf{Modèle} & \textbf{Précision} & \textbf{F1 (macro)} & \textbf{Précision équilibrée} & \textbf{MCC} & \textbf{Temps (s)} \\
    	\hline
			\texttt{large\_xgboost} 				& 0.9860 & 0.8179 & 0.8174 & 0.9609 & 3.9 	\\
			\texttt{medium\_xgboost}				& 0.9872 & 0.8134 & 0.8075 & 0.9641 & 3.1 	\\
			\texttt{large\_random\_forest} 		& 0.9866 & 0.8132 & 0.8001 & 0.9622 & 0.9 	\\
			\texttt{medium\_tab\_transformer}	& 0.9780 & 0.8129 & 0.8270 & 0.9419 & 249.2 \\
			\texttt{medium\_knn} 				& 0.9793 & 0.8095 & 0.8249 & 0.9450 & 0.0 	\\
			\texttt{small\_k5_dist\_knn} 		& 0.9793 & 0.8095 & 0.8249 & 0.9450 & 0.0 	\\
			\texttt{medium\_knn} 				& 0.9793 & 0.8095 & 0.8249 & 0.9450 & 0.0 	\\
			\texttt{large\_knn} 					& 0.9823 & 0.8053 & 0.8079 & 0.9505 & 0.0 	\\
			\texttt{small\_knn} 					& 0.9774 & 0.8007 & 0.8235 & 0.9402 & 0.0 	\\
			\texttt{small\_tab_transformer} 		& 0.9683 & 0.8001 & 0.8250 & 0.9188 & 40.7 	\\
			\texttt{medium\_random\_forest} 		& 0.9695 & 0.7936 & 0.8150 & 0.9198 & 0.6 	\\
			\texttt{medium\_attention_mlp} 		& 0.9365 & 0.7612 & 0.8163 & 0.8510 & 108.1 \\
			\texttt{small\_k10\_manhattan\_knn} 	& 0.9390 & 0.7531 & 0.8164 & 0.8564 & 0.0 	\\
			\texttt{large\_tab\_transformer} 	& 0.9475 & 0.7352 & 0.7068 & 0.8504 & 66.5 	\\
			\texttt{small\_attention\_mlp} 		& 0.9048 & 0.7259 & 0.8106 & 0.7946 & 35.2 	\\
			\texttt{medium\_ft\_transformer} 	& 0.9042 & 0.7178 & 0.7954 & 0.7806 & 126.6 \\
			\texttt{medium\_attention\_mlp} 		& 0.8969 & 0.7129 & 0.8080 & 0.7809 & 62.3 	\\
			\texttt{medium\_ft_transformer} 		& 0.8847 & 0.6974 & 0.7991 & 0.7601 & 121.0 \\
			\texttt{small\_k20\_uniform\_knn} 	& 0.8908 & 0.6969 & 0.8062 & 0.7722 & 0.0 	\\
			\texttt{small\_mlp} 					& 0.8786 & 0.6889 & 0.7988 & 0.7515 & 22.7 	\\
			\texttt{medium\_mlp} 				& 0.8700 & 0.6864 & 0.7902 & 0.7397 & 49.3 	\\
			\texttt{small\_ft\_transformer} 		& 0.8401 & 0.6593 & 0.7970 & 0.7004 & 56.1 	\\
			\texttt{small\_xgboost} 				& 0.8676 & 0.6412 & 0.7906 & 0.7287 & 0.6 	\\
			\texttt{large\_mlp} 					& 0.7724 & 0.5396 & 0.7633 & 0.6137 & 20.9	\\
			\texttt{large\_attention\_mlp} 		& 0.6949 & 0.4734 & 0.7326 & 0.5333 & 13.1 	\\
			\texttt{small\_random\_forest} 		& 0.6101 & 0.4687 & 0.7242 & 0.4779 & 0.2 	\\
			\texttt{large\_ft\_transformer} 		& 0.6992 & 0.4644 & 0.6359 & 0.5176 & 82.2 	\\
    	\hline
    \end{tabular}
	}
...
\begin{table}[H]
    ...
    \begin{tabular}{c l c c c c c}
    	...
    	\textbf{Rang} & \textbf{Modèle} & \textbf{Précision} & \textbf{F1 (macro)} & \textbf{Précision équilibrée} & \textbf{MCC} & \textbf{Temps (s)} \\
    	\hline
			\texttt{small\_random\_forest} 		& 0.8760 & 0.8688 & 0.9592 & 0.5627 & 43.0		\\
			\texttt{small\_knn} 					& 0.8990 & 0.8368 & 0.8442 & 0.3495 & 5.3 		\\
			\texttt{small\_ft\_transformer} 		& 0.8552 & 0.7743 & 0.9598 & 0.5401 & 2673.9 	\\
			\texttt{small\_mlp} 					& 0.8510 & 0.7718 & 0.9585 & 0.5333 & 745.1 	\\
			\texttt{large\_random\_forest} 		& 0.7854 & 0.7490 & 0.9382 & 0.6018 & 744.8 	\\
			\texttt{large\_xgboost} 				& 0.7786 & 0.7456 & 0.9377 & 0.5965 & 364.1 	\\
			\texttt{small\_tab\_transformer} 	& 0.4656 & 0.7042 & 0.8548 & 0.2300 & 2786.7 	\\
			\texttt{medium\_xgboost} 			& 0.7113 & 0.6961 & 0.9279 & 0.4693 & 680.7 	\\
			\texttt{medium\_xgboost} 			& 0.7113 & 0.6961 & 0.9279 & 0.4693 & 381.5 	\\
			\texttt{medium\_random\_forest} 		& 0.7058 & 0.6843 & 0.8724 & 0.4665 & 641.2 	\\
			\texttt{medium\_random\_forest} 		& 0.7058 & 0.6843 & 0.8724 & 0.4665 & 756.0 	\\
			\texttt{large\_knn} 					& 0.8708 & 0.6672 & 0.6907 & 0.5412 & 4.3 		\\
			\texttt{small\_xgboost} 				& 0.8663 & 0.6134 & 0.7095 & 0.5515 & 26.5 		\\
			\texttt{small\_attention\_mlp} 		& 0.6476 & 0.5953 & 0.8121 & 0.1380 & 1308.3 	\\
			\texttt{medium\_knn} 				& 0.8589 & 0.5909 & 0.5706 & 0.2198 & 18.4 		\\
			\texttt{medium\_knn}					& 0.8589 & 0.5909 & 0.5706 & 0.2198 & 17.3 		\\
			\texttt{medium\_attention\_mlp} 		& 0.7089 & 0.5452 & 0.7450 & 0.4650 & 161.1 	\\
			\texttt{large\_attention\_mlp} 		& 0.7700 & 0.4577 & 0.6085 & 0.5831 & 2889.7 	\\
			\texttt{medium\_mlp} 				& 0.6955 & 0.4523 & 0.7653 & 0.4563 & 24.8 		\\
			\texttt{medium\_ft\_transformer} 	& 0.7108 & 0.4457 & 0.6015 & 0.4658 & 385.7 	\\
			\texttt{medium\_tab\_transformer}	& 0.8820 & 0.3215 & 0.3307 & 0.1420 & 268.6 	\\
			\texttt{large\_mlp} 					& 0.4899 & 0.2944 & 0.4081 & 0.3221 & 2994.4 	\\
    	\hline
    \end{tabular}
	}
